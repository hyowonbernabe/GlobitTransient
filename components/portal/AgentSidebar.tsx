...
export function AgentSidebar() {
  ...
  const SidebarContent = () => (
    <>
      <div className="p-4 border-b border-gray-100 flex items-center gap-2 font-bold text-xl text-emerald-800">
        <span>💼</span>
  ...
  return (
    <>
      ...
      <aside className="hidden md:flex bg-white border-r border-gray-200 w-64 flex-col h-screen sticky top-0 shrink-0">
        <SidebarContent />
      </aside>
    </>
  )
